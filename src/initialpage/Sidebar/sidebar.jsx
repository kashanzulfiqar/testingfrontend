          ...
          <div className="sidebar-inner slimscroll">
            <div id="sidebar-menu" className="sidebar-menu">
              ...
              <ul className="sidebar-vertical" id='veritical-sidebar'>
                ...
                <li className="submenu" >
                  <a href="javascript:" className={pathname.includes('/employee/') ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "employee" ? "" : "employee")}><i className="la la-user" /> <span className="noti-dot"> Employees</span> <span className="menu-arrow" /></a>
                  {/* <a href="javascript:" className={isSideMenu == "employee" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu == "employee" ? "" : "employee")}><i className="la la-user" /> <span className="noti-dot"> Employees</span> <span className="menu-arrow" /></a> */}
                  {isSideMenu == "employee" ?
              ...
              <div className="tab-content" id="v-pills-tabContent">
                ...
                {isSideMenu == "apps" ?
                  <div className="tab-pane fade active show" id="v-pills-apps" role="tabpanel" aria-labelledby="v-pills-apps-tab">
                    ...
                    <ul>
                      <li><Link onClick={() => localStorage.setItem("minheight", "true")} to="/conversation/chat">Chat</Link></li>
                      <li className="submenu">
                        <a href="javascript:" className={level2Menu == "calls" ? "subdrop" : ""} onClick={() => toggleLvelTwo(level2Menu == "calls" ? "" : "calls")}><span> Calls</span></a>
                        {level2Menu == "calls" ?
                          <ul>
                            <li><Link onClick={() => localStorage.setItem("minheight", "true")} to="/conversation/voice-call">Voice Call</Link></li>
                            <li><Link onClick={() => localStorage.setItem("minheight", "true")} to="/conversation/video-call">Video Call</Link></li>
                ...
                {isSideMenu == "Changelog" ?
                  <div className="tab-pane fade show active" id="v-pills-changelog" role="tabpanel" aria-labelledby="v-pills-changelog-tab">
                    <p>Change Log</p>
                    <ul>
                      <li><a href="javascript:"><span>Change Log</span> <span className="badge badge-primary ms-auto">v3.4</span> </a></li>
                    </ul>
                  </div>
                  : ""
                }
                {isSideMenu == "multi Level" ?
                  <div className="tab-pane fade show active" id="v-pills-multilevel" role="tabpanel" aria-labelledby="v-pills-multilevel-tab">
                    ...
                    <ul>
                      <li className="submenu">
                        <a href="javascript:" className={level2Menu == "level 1" ? "subdrop" : ""} onClick={() => toggleLvelTwo(level2Menu == "level 1" ? "" : "level 1")}> <span>Level 1</span> </a>
                        {level2Menu == "level 1" ?
                          <ul>
                            <li><a href="javascript:" ><span>Level 2</span></a></li>
                            <li className="submenu">
