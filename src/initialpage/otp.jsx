            ...
            <div className="account-wrapper">
              ...
              <div>
                <div className="otp-wrap" >
                  <input type="text" placeholder={placeholder0} maxLength={1} onFocus={clearPlaceholder0} onBlur={restorePlaceholder0}className="otp-input"/>
                  <input type="text" placeholder={placeholder1} maxLength={1} className="otp-input" onFocus={clearPlaceholder1}  onBlur={restorePlaceholder1} />
                  <input type="text" placeholder={placeholder2} maxLength={1} className="otp-input" onFocus={clearPlaceholder2}  onBlur={restorePlaceholder2}/>
                  <input type="text" placeholder={placeholder3} maxLength={1} className="otp-input"  onFocus={clearPlaceholder3}  onBlur={restorePlaceholder3}/>
                </div>
