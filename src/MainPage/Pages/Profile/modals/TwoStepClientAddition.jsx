...
const TwoStepClientAdditionModal = ({
  ...
  const steps = [
        ...
        <Form
          ...
          onFinishFailed={({ errorFields }) => {
            const phoneErrorExists = errorFields.find((field) =>
              field.errors.toString().includes("please enter phone number")
            );
            if (phoneErrorExists) {
              setPhoneLengthError({ emp: true });
            }
        ...
        >
          <div className="row">
            <div className="col-md-12">
              <Form.Item name="logo" className="custom-border">
                <>
                  ...
                  rules={[
                    {
                      ...
                      validator: (_, value) => {
                        if (!value || value?.trim() === "") {
                          return Promise.reject(
                            t("client.pleaseEnterInvoiceEmail")
                          );
                        } else if (/\s{2,}/.test(value)) {
                          return Promise.reject(
                            t("allEmp.errors.removeConsecutiveSpaces2")
    ...
    {
      title: "Enter Focal Person Details",
      content: (
        <Form
          form={form}
          onFinish={(values) => {
        ...
        >
          <div className="row">
            <div className="col-md-12">
              <Form.Item name="focalPersonImageUrl" className="custom-border">
                <>
                  <div className="profile-img-wrap edit-img">
                    {imageLoader ? (
                      <div className="uploadImgSpinContainer">
              ...
              <div className="form-group">
                ...
                >
                  <>
                    <Input
                      style={{ display: "none" }}
                      value={emergValue?.focalPersonPhoneNo}
                    />
                    <PhoneNoInput
                      onChangePhone={(value) => {
...
export default TwoStepClientAdditionModal;
