  ...
  const columns = [
    {
      ...
      render: (_, record) => (
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          >
            {record.candidateId.firstName[0].toUpperCase() +
              record.candidateId.lastName[0].toUpperCase()}
          </div>
          <Link
            to={`/recruitment/tasks/${record._id}`}
            style={{ color: "#212529" }}
          >
            {record.candidateId.firstName.charAt(0).toUpperCase() +
              record.candidateId.firstName.slice(1).toLowerCase()}{" "}
            {record.candidateId.lastName.charAt(0).toUpperCase() +
              record.candidateId.lastName.slice(1).toLowerCase()}
          </Link>
        </div>
      ),
      // sorter: true,
    ...
    },
    {
      ...
      key: "dueDate",
      render: (_, record) => (
        <span>{moment(record.lastDateOfSubmission).format("DD MMM YYYY")}</span>
      ),
      // sorter: true,
    },
    {
                ...
                <div>
                  ...
                  <div style={{ marginTop: "12px" }}>
                    ...
                    <div style={{ display: "flex", marginTop: "7px" }}>
                      ...
                      >
                        {moment(task?.lastDateOfSubmission, "Hh:mm").format(
                          "hh:mm A"
                        )}
                      </div>
                    </div>
