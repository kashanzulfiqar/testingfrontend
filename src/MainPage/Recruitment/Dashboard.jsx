...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const statsResponse = await apiServices("GET", "candidate/stats", null, {
        access_token: {
          accessToken: token,
        },
      });
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (count, record) => (
        <div className="text-primary">{count || 0}</div>
      ),
      sorter: true,
    },
    {
  ...
  return (
    <div className="content container-fluid">
      ...
      <Row gutter={[16, 16]} style={{ marginTop: 24 }}>
        <Col xs={24} lg={12}>
          <Card title="Applications by Source" className="dashboard-card">
            <div style={{ height: 280 }}>
        ...
        <Col xs={24} lg={12}>
          <Card title="Applications by Department" className="dashboard-card">
            <div style={{ height: 280 }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <Link to="/recruitment/jobs">
              <Button type="link" style={{ color: "#56616B" }}>
                View all
              </Button>
            </Link>
          </div>
                    ...
                    <div className="job-card-content">
                      ...
                      >
                        <div>
                          <h3 className="job-title">
                            <Link to={`/recruitment/jobs/${position._id}`}>
                              {position.title
                                .split(" ")
                                .map(
                                  (word) =>
                          ...
                          <p className="positions-count">
                            {position.positions} open positions
                          </p>
                        </div>
                        <Dropdown
                          overlay={
                            <Menu>
                              <Menu.Item
                                ...
                                onClick={() =>
                                  navigate(
                                    `/recruitment/jobs/${position._id}/edit`
                                  )
                                }
                              >
                                Edit
                      ...
                      <div className="card-foot">
                        <div style={{ width: "60%" }}>
                          ...
                          <div className="social-icons">
                            {position?.postingPlatforms.includes("WEBSITE") && (
                              <img
                                className="social-icon-one"
                                src={website}
                              ></img>
                            )}
                            {position?.postingPlatforms.includes("LINKEDIN") && (
                              <img
                                className="social-icon-two"
                                src={linkedin}
                              ></img>
                            )}
                            {position?.postingPlatforms.includes("FACEBOOK") && (
                              <img
                                className="social-icon-three"
                                src={facebook}
                              ></img>
                            )}
                            {position?.postingPlatforms.includes("INDEED") && (
                              <img
                                className="social-icon-four"
                                src={indeed}
                              ></img>
                            )}
                          </div>
