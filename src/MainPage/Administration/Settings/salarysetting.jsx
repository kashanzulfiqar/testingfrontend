                ...
                <div className="settings-widget">
                  ...
                  <div className="row row-sm">
                    ...
                    <div className="col-sm-2">
                      <div className="form-group">
                        ...
                        <button className="btn btn-danger btn-block set-btn" type="button" style={{width:150,height:42}}><i className="fa fa-trash-o" /></button>
                      </div>
                    </div>
                  </div>
                  <div className="row row-sm">
                  ...
                  <div className="row row-sm">
                    <div className="col-sm-2 ms-auto">
                      <div className="form-group">
                        <button className="btn btn-primary btn-block" type="button" style={{marginLeft:790, width:150,height:42,marginTop:18}}><i className="fa fa-plus" /></button>
                      </div>
                    </div>
                  </div>
                </div>
