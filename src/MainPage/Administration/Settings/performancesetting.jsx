                          ...
                          <div className="rating-list m-t-20">
                            <span className="rating-bad">
                              <span className="rating-count">
                                <a className="me-1">0.0</a>
                                <a className="me-1">0.1</a>
                                <a className="me-1">0.2</a>
                                <a>0.3</a>
                              </span><br />
                            ...
                            <span className="rating-normal">
                              <span className="rating-count">
                                <a className="me-1">0.4</a>
                                <a className="me-1">0.5</a>
                                <a>0.6</a>
                              </span><br />
                            ...
                            <span className="rating-good">
                              <span className="rating-count">
                                <a className="me-1">0.7</a>
                                <a className="me-1">0.8</a>
                                <a className="me-1">0.9</a>
                                <a>1.0</a>
                              </span><br />
