...
const ClientsList = () => {
  ...
  const handleContextMenu = (e, client) => {
    if (e.button === 2) {
      ...
      try {
        ...
        console.log("Stored clients tab:", localStorage.getItem("clients_tab"));
      } catch (error) {
      ...
      render: (text, record) => (
        <h2 className="table-avatar">
          <Link
            ...
            state={{ client_data: record }}
            onClick={() => localStorage.setItem("clients_tab", "projects")}
            onMouseDown={(e) => handleContextMenu(e, record)}
            className="avatar"
          >
            <img alt="" src={record?.logo || user_icon} />
          </Link>
          <Link
            to="/client/client-profile"
            state={{ client_data: record }}
  ...
  return (
    <div className="page-wrapper">
      <Helmet>
        <title>
          {t("client.clientsList")} - {t("header.daftarPro")}
        </title>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-auto float-end ms-auto">
              ...
              <div className="view-icons">
                <Link to="/clients" className="grid-view btn btn-link">
          ...
          <div className="col-md-12">
            <div className="table-responsive clientTable">
              <Table
                ...
                style={{
                  overflowX: "auto",
                  height: `${allClients?.length > 0 ? "485px" : "384px"}`,
                }}
                pagination={false}
                columns={columns}
                // bordered
