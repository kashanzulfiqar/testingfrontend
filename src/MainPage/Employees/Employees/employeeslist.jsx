             ...
             {/* Search Filter */}
              ...
              <div className="row filter-row">
                ...
                <div className="col-sm-6 col-md-3" style={{display: 'flex', alignItems: 'flex-start', gap: '13px'}}>  
                  ...
                  <button href="javascript:void(0)" type="reset" onClick={() => { form.resetFields(); getEmployees('', 1, pageSize); setFilterValues(null); setCurrentPage(1)}} className="btn btn-success btn-block w-50" style={{backgroundColor: '#616161', color: 'white', borderColor: '#aeaeae'}} disabled={((role === 'admin' ? false : true) || !permissions?.viewAllUsers)}> Reset </button>  
                </div>
              </div>
              </Form>
             {/* /Search Filter */}
