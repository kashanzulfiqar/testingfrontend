...
function WeekViewTimeSheet({
  ...
  const groupedData = allData?.reduce((result, item) => {
    ...
    result[key].totalDuration += durationToMinutes(
      item?.hoursWorked ? item?.hoursWorked : "00:00"
    );
    return result;
  }, {});
        ...
        <>
          {record?.projectId?.projectName ? (
            <label
              ...
              style={{ textWrap: "nowrap", fontWeight: "500" }}
            >
              {record?.projectId?.projectName}
            </label>
