...
function DayViewTimesheet({
  ...
  let t_data = [
    {
      ...
      notes:
        "lkklklj444 lkjlkjlk lkjlkj lklkjl lkjlkj lkjklj lkjlkj jhg h gf jhk hkj iuy kj kjh iuy uiyiuyiu yuiiy ytytrytryt yttyryt rytrytry ytytrty ygjhh kj444.",
    },
    {
      _id: 2,
      projectId: {
  ...
  const getData = (current_page, page_size) => {
    ...
    apiServices(
      ...
      `timesheet?page=${
        ...
        current_date ? `&timesheetFrom=${current_date}` : ""
      }${
        current_date ? `&timesheetTo=${current_date}` : ""
      }&employeeOnly=${true}`,
      null,
      user_state
    )
            ...
            allData.map((data) => {
              if (data._id === open?.data?._id) {
                return {
                  ...
                  ...updated_data,
                  projectId: {
                    _id: open?.data?.projectId?._id,
                    projectName: open?.data?.projectId?.projectName,
                  },
                  taskId: {
                    _id: open?.data?.taskId?._id,
                    title: open?.data?.taskId?.title,
                  },
                };
              } else {
                return {
  ...
  const onFormValuesChange = () => {
    ...
    let current_data = {
      ...
      hoursWorked: currentValues?.hoursWorked
        ? moment(currentValues?.hoursWorked).format("HH:mm")
        : "",
    ...
    const areObjectsEqual =
      JSON.stringify(current_data) === JSON.stringify(initial_data);
  ...
  const totalTime = () => {
    const totalMinutes = allData?.reduce(
      (acc, item) =>
        acc +
        item?.hoursWorked
          ?.split(":")
  ...
  return (
    <div>
      <>
        <div
          className="table-responsive timeSheetDayTable"
        ...
        {tableLoader ? (
                  ...
                  >
                    ...
                    {record?.notes?.length > 0 && (
                      <div style={{ marginRight: "25px" }}>
                        <p style={{ margin: "0px" }}>
                          <label className="text-muted longText2">
                            {record?.notes}
                          </label>
                        </p>
                      </div>
                      ...
                      <div className="dropdown-menu dropdown-menu-right">
                        <a
                          ...
                          onClick={() => {
                            ...
                            let data = {
                              ...record,
                              selectedId: record?.projectId?._id
                                ? record?.projectId?._id
                                : record?.boardId?._id,
          ...
          >
            <label>
              {t("Timesheetemployee.emptytimesheet")}{" "}
              <label
                style={{
                  color: "#FF9B44",
              ...
              >
                <div className="row">
                            ...
                            rules={[
                              {
                                ...
                                required: true,
                                message: t(
                                  "please select project or taskboard"
                                ),
                              },
                            ]}
                          >
                  ...
                  <div className="col-12">
                    <div className="form-group">
                      <label>
                        {t("Timesheetemployee.enterduration")}{" "}
                        <span className="text-danger">*</span>
                      </label>
                              ...
                              validator: (_, value) => {
                                if (!value) {
                                  return Promise.reject(
                                    t(
                                      "Timesheetemployee.pleaseentertaskduration"
                                    )
                                  );
                                } else if (
                                  ...
                                  return Promise.reject(
                                    t(
                                      "Timesheetemployee.taskDurationCannotBeZero"
                                    )
                                  );
                                }
                        ...
                        rules={[
                          {
                            ...
                            validator: (_, value) => {
                              if (!value || value.trim() === "") {
                                ...
                                return Promise.reject(
                                  t(
                                    "Timesheetemployee.notesLengthMustBeAtLeastFive"
                                  )
                                );
                              }
                              return Promise.resolve();
                ...
                <div className="submit-section">
                  <button
                    ...
                    disabled={loader || open?.data ? buttonDisable : false}
                  >
                    {loader ? (
