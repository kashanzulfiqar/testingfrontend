...
const AllEmployees = () => {
  ...
  const handleDownloadSample = async () => {
    const url =
      "https://res.cloudinary.com/dcxpovyr9/raw/upload/v1724867279/nayhp1o5iq3ajz0zcoor";
    ...
    apiServices(
      ...
      `user/view-user?deleted=false${
        ...
        values === ""
          ...
          ? ""
          : values?.employeeId
          ? `&employeeId=${encodeURIComponent(values?.employeeId)}`
          : filterValues?.employeeId
          ? `&employeeId=${encodeURIComponent(filterValues?.employeeId)}`
          : ""
      }${
        values === ""
          ? ""
        ...
        values === ""
          ...
          ? `&userRole=${filterValues?.userRole}`
          : ""
      }${
        values === ""
          ? ""
          ...
          : filterValues?.status
          ? `&userStatus=${filterValues?.status}`
          : ""
      }&page=${
    ...
    excelImport(uploadFile, company_id, user_email)
      .then((res) => {
        if (res?.data?.success == true) {
          setLoader(false);
          message.success(
            "Importing employee data. You'll be notified by email when done."
          );
          closeUpload();
        }
      })
      .catch((err) => {
        message.error(
          err?.response?.data?.msg
            ...
            : err?.response?.data?.validation?.body?.message
            ? err?.response?.data?.validation?.body?.message
            : t("projectScreen.errors.fileUploadError", {
  ...
  const onFinishAdd = (values) => {
    ...
    apiServices("POST", "user/add-user", new_values, user_state)
      ...
      .catch((err) => {
        ...
        if (
          err?.response?.data?.msg === "Input Valid Number" &&
    ...
    <Empty
      ...
      description={
        <div style={{ display: "" }}>
          ...
          >
            {role === "admin" || permissions?.viewAllUsers
              ? "No Employee Record found!"
              : "You are Restricted to View Employees"}
          </div>
          {/* <div
              ...
              <div className="row filter-row">
                <div className="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">
                  <div className="form-group">
                    <Form.Item name="employeeId" className="custom-border">
                      <Input
                ...
                <div className="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">
                  <div className="form-group">
                    <Form.Item name="employeeName" className="custom-border">
                      <Input
                        className="form-control"
                        style={{ height: "50px" }}
                ...
                <div className="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">
                  <div style={{ position: "relative" }} id="area1">
                    <Form.Item name="designation" className="custom-border">
                      <Select
                ...
                <div className="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">
                  <div style={{ position: "relative" }} id="area1">
                    <Form.Item name="userRole" className="custom-border">
                      <Select
                        className="custom-select"
                        style={{
                          width: "100%",
                    ...
                    >
                      <div className="profile-widget" style={{ width: "100%" }}>
                        <div className="profile-img">
                          <Link
                            to={`/profile/employee-profile/${user?._id}`}
                            onClick={() =>
                          ...
                          >
                            <img
                              src={user?.imageUrl ? user?.imageUrl : user_icon}
                              alt=""
                            />
                          </Link>
                        </div>
          ...
          >
            <div className="modal-dialog modal-dialog-centered">
              <div
                ...
                style={{
                  height:
                    open?.data?.userStatus === "Active" ? "406px" : "280px",
                }}
              >
                {open?.data?.userStatus === "Active" ? (
                  <div className="modal-body">
                    <Form
                      ...
                      name="control-hooks"
                      onFinish={(val) =>
                        onFinishDelete(open?.data?._id, "disable", val)
                      }
                    ...
                    >
                      ...
                      >
                        <h3 style={{ marginBottom: "20px" }}>
                          {t("allEmp.disableEmployee")}
                        </h3>
                        <p style={{ fontSize: "15px" }}>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: t("allEmp.disableConfirmation", {
                                fullName: open?.data?.fullName,
                              }),
                            }}
                          />
                  ...
                  >
                    <div className="form-header">
                      ...
                      <p>
                        <span
                          dangerouslySetInnerHTML={{
                            __html: t("allEmp.enableConfirmation", {
                              fullName: open?.data?.fullName,
                            }),
                          }}
                        />
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (
                              ...
                              message.error(
                                "Please select a .xls or .xlsx file."
                              );
                            }
                          }}
                          type="file"
