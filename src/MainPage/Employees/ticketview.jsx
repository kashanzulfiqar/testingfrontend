               ...
               <div className="chat-window">
                 <div className="fixed-header">
                   <div className="navbar">
                     ...
                     <Link className="task-chat profile-rightbar float-end" id="task_chat" to="#task_window"><i className="fa fa fa-comment" /></Link>
                   </div>
                 </div>
                                 ...
                                 <div className="m-b-20">
                                   ...
                                   <div className="float-end ticket-priority"><span>Priority:</span>
                                     <div className="btn-group">
                                       <Link to="#" className="badge badge-danger dropdown-toggle" data-bs-toggle="dropdown">Highest </Link>
                                       <div className="dropdown-menu dropdown-menu-right">
                                         <Link className="dropdown-item" to="#"><i className="fa fa-dot-circle-o text-danger" /> Highest priority</Link>
                                         <Link className="dropdown-item" to="#"><i className="fa fa-dot-circle-o text-info" /> High priority</Link>
                                         <Link className="dropdown-item" to="#"><i className="fa fa-dot-circle-o text-primary" /> Normal priority</Link>
                                         <Link className="dropdown-item" to="#"><i className="fa fa-dot-circle-o text-success" /> Low priority</Link>
                                       </div>
                                     </div>
                                   </div>
                                 </div>
                               ...
                               <ul className="files-list">
                                 <li>
                                   <div className="files-cont">
                                     ...
                                     <div className="files-info">
                                       <span className="file-name text-ellipsis"><Link to="#">Ticket_document.xls</Link></span>
                                       <span className="file-author"><Link to="#">John Doe</Link></span> <span className="file-date">May 5th at 8:21 PM</span>
                                       <div className="file-size">Size: 14.8Mb</div>
                                     </div>
                                     <ul className="files-action">
                                       <li className="dropdown dropdown-action">
                                         <Link to="" className="dropdown-toggle btn btn-link" data-bs-toggle="dropdown" aria-expanded="false"><i className="material-icons">more_horiz</i></Link>
                                         <div className="dropdown-menu dropdown-menu-right">
                                           <Link className="dropdown-item" to="javascript:void(0)">Download</Link>
                                 ...
                                 <li>
                                   <div className="files-cont">
                                     ...
                                     <div className="files-info">
                                       <span className="file-name text-ellipsis"><Link to="#">Issue_report.xls</Link></span>
                                       <span className="file-author"><Link to="#">John Doe</Link></span> <span className="file-date">May 5th at 5:41 PM</span>
                                       <div className="file-size">Size: 14.8Mb</div>
                                     </div>
                                     <ul className="files-action">
                                       <li className="dropdown dropdown-action">
               ...
               <div className="chat-window">
                 <div className="fixed-header">
                   <div className="navbar">
                     <div className="task-assign">
                       ...
                       <Link to="#" data-bs-toggle="tooltip" data-placement="bottom" title="John Doe" className="avatar">
                         <img src={Avatar_02} alt="" />
                       </Link>
                       <Link to="#" className="followers-add" title="Add Assignee" data-bs-toggle="modal" data-bs-target="#assignee"><i className="material-icons">add</i></Link>
                     </div>
                     <ul className="nav float-end custom-menu">
                       <li className="nav-item dropdown dropdown-action">
                         <Link to="" className="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i className="material-icons">more_vert</i></Link>
                         <div className="dropdown-menu">
                           <Link className="dropdown-item" to="#" data-bs-toggle="modal" data-bs-target="#edit_ticket">Edit Ticket</Link>
                           <Link className="dropdown-item" to="#" data-bs-toggle="modal" data-bs-target="#delete_ticket">Delete Ticket</Link>
                         </div>
                       </li>
                     </ul>
                   </div>
                         ...
                         <div className="chats">
                               ...
                               <div className="chat-bubble">
                                 <div className="chat-content">
                                   ...
                                   <ul className="attach-list">
                                     <li><i className="fa fa-file" /> <Link to="#">project_document.avi</Link></li>
                                     <li><i className="fa fa-file" /> <Link to="#">video_conferencing.psd</Link></li>
                                     <li><i className="fa fa-file" /> <Link to="#">landing_page.psd</Link></li>
                                   </ul>
                                 </div>
                               </div>
                             </div>
                                 ...
                                 <div className="chat-content">
                                   ...
                                   <ul className="attach-list">
                                     <li className="img-file">
                                       <div className="attach-img-download"><Link to="#">avatar-1.jpg</Link></div>
                           ...
                           <div className="task-information">
                             <span className="task-info-line">
                               <Link className="task-user" to="#">John Doe</Link> 
                 ...
                 <div className="chat-footer">
                   ...
                   <div className="project-members task-followers">
                     ...
                     <Link to="#" data-bs-toggle="tooltip" title="Wilmer Deluna" className="avatar">
                       <img src={Avatar_11} alt="" />
                     </Link>
                     <Link to="#" className="followers-add" data-bs-toggle="modal" data-bs-target="#task_followers"><i className="material-icons">add</i></Link>
                   </div>
                 </div>
               </div>
             </div>
